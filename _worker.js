...
const renderLoginPage = async () => {
    ...
    <style>
        ...
        h1 { font-size: 2.5rem; text-align: center; color: rgb(255, 128, 64); margin: 0 auto 30px; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.25); }        
        h2 {text-align: center;color: rgb(255, 128, 64);}
        .form-container {
            background: #f9f9f9;
            border: 1px solid #eaeaea;
            border-radius: 10px;
